                      ...
                      const int incX, const float *Y, const int incY)
{
   const char * dsdot_kernel = "\n" \
         ...
         "#endif \n" \
         "__kernel void dsdot(__global float* X, __global float* Y, __global double *res, int N, int incX, int incY) { \n" \
         ...
         "}";
   double res = 0;
   cblas_run_2vec_r(N, (void *)X, incX, (void *)Y, incY, (void *)&res, 1, 0, 0, NULL, dsdot_kernel, "dsdot");
   return res;
}   
